...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tree_widget_data.setMinimumSize(QtCore.QSize(520, 0))
        ...
        self.tree_widget_data.setColumnCount(4)
        self.tree_widget_data.setObjectName("tree_widget_data")
        self.tree_widget_data.headerItem().setTextAlignment(1, QtCore.Qt.AlignLeading|QtCore.Qt.AlignVCenter)
        self.tree_widget_data.header().setDefaultSectionSize(120)
        self.tree_widget_data.header().setHighlightSections(True)
        self.verticalLayout.addWidget(self.tree_widget_data)
        self.pushButton = QtWidgets.QPushButton(self.data_inspector_contents)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tree_widget_data.headerItem().setText(1, _translate("MainWindow", "Cropped"))
        self.tree_widget_data.headerItem().setText(2, _translate("MainWindow", "Segmented"))
        self.tree_widget_data.headerItem().setText(3, _translate("MainWindow", "Centerlines"))
        self.pushButton.setText(_translate("MainWindow", "Load Selected File"))
